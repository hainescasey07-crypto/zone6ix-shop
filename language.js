(() => {
  ...
  const es = {
    ...
    "Turfs": "Territorios",
    "Weapons": "Armas",
    "Identity": "Personalización",
    "Player": "Jugador",
    "Player Customisation": "Personalización del jugador",
    "Process": "Proceso",
    ...
    "Premium custom turfs, exclusive weapons and full gang identity systems designed for the Zone6ix experience.": "Territorios personalizados premium, armas exclusivas y personalización individual de jugadores para la experiencia Zone6ix.",
    "Premium custom turfs, exclusive weapons and individual player customisation designed for the Zone6ix experience.": "Territorios personalizados premium, armas exclusivas y personalización individual de jugadores para la experiencia Zone6ix.",
    ...
    "GANG IDENTITY": "PERSONALIZACIÓN DEL JUGADOR",
    "PLAYER CUSTOMISATION": "PERSONALIZACIÓN DEL JUGADOR",
    "Make your individual player stand out.": "Haz que tu jugador individual destaque.",
    "Customise one player with a name, Roblox-supported emoji and level display.": "Personaliza a un jugador con un nombre, un emoji compatible con Roblox y un nivel.",
    "THE ZONE6IX EVENT STORE.": "LA TIENDA DE EVENTOS ZONE6IX.",
    "Stay active, earn Zone Tokens and unlock limited items released directly by the Zone6ix team.": "Mantente activo, gana Zone Tokens y desbloquea artículos limitados publicados por el equipo de Zone6ix.",
    ...
    "BRANDING": "MARCA",
    "Name, icon and level styling that makes your gang recognisable.": "Nombre, emoji y nivel para personalizar a un jugador.",
    "Name, emoji and level styling for individual players.": "Nombre, emoji y nivel para jugadores individuales.",
    "CUSTOM TURFS": "TERRITORIOS PERSONALIZADOS",
    ...
    "IDENTITY": "IDENTIDAD",
    "Name, icon and level": "Nombre, emoji y nivel",
    "Name, emoji and level": "Nombre, emoji y nivel",
    ...
    "IDENTITY SYSTEM": "PERSONALIZACIÓN DEL JUGADOR",
    "PLAYER CUSTOMISATION SYSTEM": "SISTEMA DE PERSONALIZACIÓN",
    ...
    "Gang shirt link": "Enlace de la camiseta de la banda",
    "Gang pants link": "Enlace de los pantalones de la banda",
    "Gang group link": "Enlace del grupo de la banda",
    "LIVE ROBLOX CHECK": "COMPROBACIÓN DE ROBLOX EN DIRECTO",
    "Player and clothing preview": "Vista previa del jugador y la ropa",
    "Refresh preview": "Actualizar vista previa",
    "Loading…": "Cargando…",
    "Add your Roblox username": "Añade tu usuario de Roblox",
    "Your current avatar will appear here. Paste shirt and pants links to check the exact clothing assets beside it.": "Tu avatar actual aparecerá aquí. Pega los enlaces de la camiseta y los pantalones para comprobar los artículos exactos al lado.",
    "Loading Roblox preview…": "Cargando vista previa de Roblox…",
    "CURRENT AVATAR": "AVATAR ACTUAL",
    "Roblox player": "Jugador de Roblox",
    "Open profile": "Abrir perfil",
    "SHIRT LINK": "ENLACE DE CAMISETA",
    "PANTS LINK": "ENLACE DE PANTALONES",
    "Not added": "No añadido",
    "Open shirt": "Abrir camiseta",
    "Open pants": "Abrir pantalones",
    "The preview uses Roblox’s live avatar and asset thumbnails so you can confirm the correct username, shirt and pants before ordering.": "La vista previa usa el avatar y las miniaturas de Roblox para que puedas confirmar el usuario, la camiseta y los pantalones correctos antes de pedir.",
    "Enter a Roblox username first.": "Introduce primero un usuario de Roblox.",
    "Enter a valid Roblox username.": "Introduce un usuario de Roblox válido.",
    "That Roblox username could not be found.": "No se pudo encontrar ese usuario de Roblox.",
    "Use a full Roblox clothing link.": "Usa un enlace completo de ropa de Roblox.",
    "Use a Roblox clothing link.": "Usa un enlace de ropa de Roblox.",
    "Could not find an asset ID in that Roblox link.": "No se pudo encontrar el ID del artículo en ese enlace de Roblox.",
    "Thumbnail unavailable": "Miniatura no disponible",
    "Avatar thumbnail unavailable": "Miniatura del avatar no disponible",
    "Could not load the Roblox preview.": "No se pudo cargar la vista previa de Roblox.",
    "Gang shirt": "Camiseta de la banda",
    "Gang pants": "Pantalones de la banda",
    "Gang group": "Grupo de la banda",
    "optional": "opcional",
    ...
    "Add a turf, weapon or identity upgrade to begin.": "Añade un territorio, un arma o una personalización de jugador para empezar.",
    ...
    "Custom Player Name": "Nombre personalizado del jugador",
    "Custom Icon": "Emoji personalizado",
    "Custom Emoji": "Emoji personalizado",
    "Custom Player Emoji": "Emoji personalizado del jugador",
    "Custom Level": "Nivel personalizado",
    "Custom Player Level": "Nivel personalizado del jugador",
    "Identity Bundle": "Paquete de personalización",
    "Player Customisation Bundle": "Paquete de personalización del jugador",
    ...
    "A custom name display for one individual player, styled to stand out above their character in Zone6ix.": "Un nombre personalizado para un jugador individual, diseñado para destacar sobre su personaje en Zone6ix.",
    "Add an emoji beside one individual player’s name. Choose a Roblox-supported emoji that matches their style.": "Añade un emoji junto al nombre de un jugador individual. Elige un emoji compatible con Roblox que combine con su estilo.",
    "Choose a custom level or status display for one individual player rather than the whole gang.": "Elige un nivel o estado personalizado para un jugador individual, no para toda la banda.",
    "Custom player name, emoji and level together for one individual player at a lower bundle price.": "Nombre, emoji y nivel personalizados juntos para un jugador individual a un precio de paquete más bajo.",
  };
  ...
  function translateStatic(root = document.body) {
    ...
    if (description) {
      description.content = currentLanguage === "es"
        ? "Zone6ix Customs: territorios personalizados premium, armas exclusivas y personalización individual del jugador."
        : "Zone6ix Customs — premium custom turfs, gang weapons and individual player customisation.";
    }
  }
